        ...
        |ctx| {
            let mut view = RootView::new(
                ...
                NewWorkspaceSource::TransferredTab {
                    ...
                    vertical_tabs_panel_width: transferred_tab.vertical_tabs_panel_width,
...
pub enum NewWorkspaceSource {
    ...
    TransferredTab {
        ...
        /// Captured from the source window so detached tabs inherit the panel width.
        vertical_tabs_panel_width: f32,
