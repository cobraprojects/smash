...
define_settings_group!(AISettings, settings: [
    smash_ollama_url: SmashOllamaUrl {
        type: String,
        default: "http://127.0.0.1:11434".to_owned(),
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "agents.smash.providers.ollama_url",
        description: "Base URL for the Ollama server used by Smash.",
    },
    smash_lm_studio_url: SmashLmStudioUrl {
        type: String,
        default: "http://127.0.0.1:1234".to_owned(),
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "agents.smash.providers.lm_studio_url",
        description: "Base URL for the LM Studio server used by Smash.",
    },
    ...
    // be automatically detected and spawned. Smash-native config files (.smash/.mcp.json) are
