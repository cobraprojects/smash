    ...
    app.register_fixed_bindings(vec![
        FixedBinding::empty(
            if ChannelState::channel() == Channel::Oss {
                "Toggle Input Mode (Smash/Classic)".to_string()
            } else {
...
impl SettingsWidget for CreateCustomThemeWidget {
    ...
    fn render(
        ...
        let custom_theme_help = if ChannelState::channel() == Channel::Oss {
            appearance
                .ui_builder()
                .span("Custom themes are loaded from your Smash themes directory.".to_string())
                .build()
                .finish()
        } else {
            appearance
        ...
        Align::new(
            Container::new(custom_theme_help)
                ...
                && app_icon_at_startup != AppIcon::Default
            {
                ...
                let column = Flex::column().with_child(dropdown).with_child(
                    appearance
                        ...
                        .wrappable_text(
                            if ChannelState::channel() == Channel::Oss {
                                "You may need to restart Smash for macOS to apply the preferred icon style."
                            } else {
...
impl SettingsWidget for WindowBlurWidget {
    ...
    fn render(
        ...
        let label_info = (ChannelState::channel() != Channel::Oss).then(|| AdditionalInfo {
    ...
    fn render(
        ...
        let radio_buttons = appearance
            ...
            .radio_buttons(
                ...
                vec![
                    RadioButtonItem::text(if ChannelState::channel() == Channel::Oss {
                        "Smash"
                    } else {
                        "Warp"
                    }),
