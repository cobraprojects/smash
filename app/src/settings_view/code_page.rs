...
const CODEBASE_INDEX_DESCRIPTION: &str = "Smash can automatically index code repositories as you navigate them, helping agents quickly understand context and provide solutions. Code is never stored on a server. If a codebase cannot be indexed, Smash can still inspect it with grep and find.";
...
const AUTO_INDEX_DESCRIPTION: &str = "When enabled, Smash automatically indexes code repositories as you navigate them so agents can understand context and provide targeted solutions.";
    ...
    fn render(
        ...
        render_body_item::<CodeSettingsPageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "Automatically saves changes in the Smash text editor as you type and when the editor loses focus."
                    .into(),
            ),
        )
    }
