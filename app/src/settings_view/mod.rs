...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let initial_page = match page {
            Some(SettingsSection::Account) | None if is_smash => SettingsSection::WarpAgent,
    ...
    pub fn set_and_refresh_current_page_internal(
        ...
        let section = if ChannelState::channel() == warp_core::channel::Channel::Oss
            && matches!(
                section,
                SettingsSection::Account
                    | SettingsSection::BillingAndUsage
