...
static SAFE_MODE_DESCRIPTION: LazyLock<&'static str> = LazyLock::new(|| {
    "When this setting is enabled, Smash scans terminal blocks and agent prompts for potential \
        sensitive information before content is sent to configured providers. You can customize \
        this list with regular expressions."
});
...
const TELEMETRY_TITLE: &str = "Help improve Smash";
const TELEMETRY_DESCRIPTION: &str = "App analytics help us make the product better for you. We may collect \
    certain console interactions to improve Smash's AI capabilities.";
