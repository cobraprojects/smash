...
define_settings_group!(TabSettings, settings: [
    ...
    session_sidebar_show_details: SessionSidebarShowDetails {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "appearance.session_sidebar.show_details",
        description: "Whether the session sidebar shows metadata below session names.",
    },
    session_sidebar_show_tab_count: SessionSidebarShowTabCount {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "appearance.session_sidebar.show_tab_count",
        description: "Whether the session sidebar shows the number of tabs in each session.",
    },
    session_sidebar_show_working_directory: SessionSidebarShowWorkingDirectory {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "appearance.session_sidebar.show_working_directory",
        description: "Whether the session sidebar shows the active tab's working directory.",
    },
    session_sidebar_show_git_branch: SessionSidebarShowGitBranch {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "appearance.session_sidebar.show_git_branch",
        description: "Whether the session sidebar shows the active tab's git branch.",
    },
    session_sidebar_compact_paths: SessionSidebarCompactPaths {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "appearance.session_sidebar.compact_paths",
        description: "Whether the session sidebar shows only the trailing working-directory path segment.",
    },
