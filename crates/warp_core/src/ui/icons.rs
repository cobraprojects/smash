...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WarpDrive => match ChannelState::channel() {
                Channel::Oss => "bundled/svg/smash.svg",
                Channel::Stable
                | Channel::Preview
                | Channel::Dev
                | Channel::Local
                | Channel::Integration => "bundled/svg/warp.svg",
            },
            Icon::Warp => match ChannelState::channel() {
                Channel::Oss => "bundled/svg/smash.svg",
                Channel::Stable
                | Channel::Preview
                | Channel::Dev
                | Channel::Local
                | Channel::Integration => "bundled/svg/warp-drive.svg",
            },
            Icon::WarpLogoLight => match ChannelState::channel() {
                Channel::Oss => "bundled/svg/smash-logo-light.svg",
                Channel::Stable
                | Channel::Preview
                | Channel::Dev
                | Channel::Local
                | Channel::Integration => "bundled/svg/warp-logo-light.svg",
            },
            ...
            Icon::Agent => match ChannelState::channel() {
                Channel::Oss => "bundled/svg/smash.svg",
                Channel::Stable
                | Channel::Preview
                | Channel::Dev
